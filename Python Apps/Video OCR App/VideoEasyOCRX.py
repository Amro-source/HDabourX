...
class VideoOCRApp(wx.Frame):
    ...
    def init_ui(self):
        ...
        # Slider
        self.frame_slider = wx.Slider(panel, value=0, minValue=0, maxValue=100, style=wx.SL_HORIZONTAL)
        ...
        sizer.Add(self.frame_slider, 0, wx.EXPAND | wx.ALL, 5)
    ...
    def load_video(self, event):
        with wx.FileDialog(self, "Open Video File", wildcard="Video files (*.mp4;*.avi)|*.mp4;*.avi",
            ...
            self.frame_slider.SetMax(self.total_frames - 1)
            self.show_frame(0)
    ...
    def on_slider_change(self, event):
        frame_no = self.frame_slider.GetValue()
    ...
    def perform_ocr(self, event):
        ...
        self.text_output.SetValue(recognized_text)
