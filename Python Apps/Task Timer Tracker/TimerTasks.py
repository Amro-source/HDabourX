...
class StopwatchApp(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        # Add controls
        self.description_input = wx.TextCtrl(self.panel, style=wx.TE_PROCESS_ENTER)
        self.description_input.SetHint("Enter activity description")
        self.start_button = wx.Button(self.panel, label="Start New Stopwatch")
        self.export_button = wx.Button(self.panel, label="Export to CSV")
        
        self.main_sizer = wx.BoxSizer(wx.VERTICAL)
        
        # Header Row
        header_sizer = wx.BoxSizer(wx.HORIZONTAL)
        header_sizer.Add(wx.StaticText(self.panel, label="ID", style=wx.ALIGN_CENTER), flag=wx.EXPAND, proportion=1)
        header_sizer.Add(wx.StaticText(self.panel, label="Description", style=wx.ALIGN_CENTER), flag=wx.EXPAND, proportion=2)
        header_sizer.Add(wx.StaticText(self.panel, label="Status", style=wx.ALIGN_CENTER), flag=wx.EXPAND, proportion=1)
        header_sizer.Add(wx.StaticText(self.panel, label="Duration", style=wx.ALIGN_CENTER), flag=wx.EXPAND, proportion=1)
        header_sizer.Add(wx.StaticText(self.panel, label="Actions", style=wx.ALIGN_CENTER), flag=wx.EXPAND, proportion=2)
    ...
    def on_start_stopwatch(self, event):
        ...
        row_sizer.Add(wx.StaticText(self.panel, label=str(stopwatch_id), style=wx.ALIGN_CENTER), flag=wx.EXPAND, proportion=1)
        row_sizer.Add(wx.StaticText(self.panel, label=description, style=wx.ALIGN_CENTER), flag=wx.EXPAND, proportion=2)
        status_label = wx.StaticText(self.panel, label="Running", style=wx.ALIGN_CENTER)
        row_sizer.Add(status_label, flag=wx.EXPAND, proportion=1)
        duration_label = wx.StaticText(self.panel, label="0:00:00", style=wx.ALIGN_CENTER)
        ...
        # Buttons
        actions_panel = wx.Panel(self.panel)
