...
class FinancialApp(wx.Frame):
    def __init__(self, *args, **kw):
        super(FinancialApp, self).__init__(*args, **kw)
    ...
    def InitUI(self):
        ...
        self.SetTitle('Financial Planning App')
    ...
    def OnSave(self, event):
        ...
        for income in self.income_list:
            ET.SubElement(income_elem, "Item").text = income

        expense_elem = ET.SubElement(root, "Expenses")
        for expense in self.expense_list:
            ET.SubElement(expense_elem, "Item").text = expense
    ...
    def OnLoad(self, event):
        if os.path.exists("financial_data.xml"):
            ...
            wx.MessageBox("No data file found.", "Error", wx.MessageBox.OK | wx.ICON_ERROR)
