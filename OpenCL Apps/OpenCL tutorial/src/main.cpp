...
int main() {
    ...
    std::cout << "Using platform: " << platformName.data() << std::endl;

    // Step 2: Get the first GPU device
    cl_uint deviceCount;
    ...
    // Step 4: Load the OpenCL kernel from file
    ...
    // Step 5: Create and build the program
