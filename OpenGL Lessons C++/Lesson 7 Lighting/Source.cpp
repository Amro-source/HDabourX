...
void processInput(GLFWwindow* window) {
    float cameraSpeed = 0.01f; // Reduced from 0.05f to 0.01f for smaller steps
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Pass directional light to shader
