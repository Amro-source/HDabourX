...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "3D Lit Cube Grid", nullptr, nullptr);
    if (!window) return -1;
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::mat4 view = glm::lookAt(
            glm::vec3(20.0f, 20.0f, 20.0f), // Move camera further away
            glm::vec3(0.0f, 0.0f, 0.0f),    // Look at the center of the grid
            glm::vec3(0.0f, 1.0f, 0.0f)     // Up vector
        );
        glm::mat4 projection = glm::perspective(
            glm::radians(60.0f),            // Increase FOV to 60 degrees
